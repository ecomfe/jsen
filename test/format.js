define(function (require) {
    ...
    describe('format', function () {
        ...
        it('email', function () {
            ...
            var validate = jsen(schema);
            var maxLongHostname1 = new Array(5).join('.' + new Array(64).join('a')).substr(1); // 255 chars (4 groups x 63 chars)
            var maxLongHostname2 = new Array(9).join('.' + new Array(32).join('a')).substr(1); // 255 chars (8 groups x 31 chars)
        ...
        it('hostname', function () {
            ...
            var validate = jsen(schema);
            var maxLong1 = new Array(5).join('.' + new Array(64).join('a')).substr(1); // 255 chars (4 groups x 63 chars)
            var maxLong2 = new Array(9).join('.' + new Array(32).join('a')).substr(1); // 255 chars (8 groups x 31 chars)
        ...
        describe('custom format', function () {
            ...
            it('accepts function', function () {
                ...
                var callCount = 0;
                var custom = function (value, childSchema) {
